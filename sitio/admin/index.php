...
require_once RUTA_RAIZ . '/bootstrap/autoload.php';
...
$requiereAutenticacion = $rutas[$vistas]['autenticacion'] ?? false;
    ...
    <nav class=" nav navbar-expand navbar-dark pt-4">
        <div id="barra" class="navbar-collapse collapse">
            <ul class="navbar-nav nav-tabs text-center ms-auto">
                ...
                <li class="nav-item px-2 mx-2"><a class="btn nav-link" href="index.php?v=productos">Productos</a></li>
