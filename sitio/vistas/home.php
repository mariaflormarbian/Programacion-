    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block" src="./imgs/slider1.png " alt="Remera promoción">
            </div>
            <div class="carousel-item">
                <img class="d-block" src="./imgs/slider2.png " alt="Compra ahora remera">
            </div>
            <div class="carousel-item">
                <img class="d-block" src="./imgs/slider3.png" alt="Dibujo de tu remera">
            </div>
        </div>
